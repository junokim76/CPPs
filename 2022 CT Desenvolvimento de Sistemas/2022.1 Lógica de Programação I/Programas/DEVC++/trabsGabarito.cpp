...
char perguntarAlternativa(int indice){
	char resposta;
	do{
		cout<<"Resposta da "<<indice+1<<"ª questão (A, B, C, D ou E): ";
		cin>>resposta;
...
int main(){
	...
	/*Até aqui: 
		- Solicitar a quantidade de candidatos (N) e total de questões (M)
		- Solicitar gabarito
		- Confirmar gabarito
		...
		- Gerar relatório de nomes e notas
		- Calcular média dos candidatos
		- Quantidade de candidatos classificados
		- Relatório dos candidatos classificados
