...
int i,
//char a[b];
void validaGabarito(char a, int b){
		int b=0;
		char a[b];
		if(a[b]!='A' && a[b]!='B' && a[b]!='C' && a[b]!='D' && a[b]!='E' 
				&& a[b]!='a' && a[b]!='b' && a[b]!='c' && a[b]!='d' && a[b]!='e'){
					cout << "\nOpcao invalida! ==> " << a[b]<<"\n";
				}
}
int main(){
	...
	int nCandidatos=-99999999, nQuestoes=-9999999,  iCan=0;
